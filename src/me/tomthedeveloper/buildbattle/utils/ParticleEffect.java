...
import me.tomthedeveloper.buildbattle.utils.ReflectionHandler.PackageType;
...
public enum ParticleEffect {
     ...
     * </ul>
     */
    WATER_BUBBLE("WaterBubble", 4, -1, ParticleProperty.DIRECTIONAL),//, ParticleProperty.REQUIRES_WATER),
    /**
     ...
     * @see ParticlePacket
     * @see ParticlePacket#sendTo(org.bukkit.Location, double)
     */
     ...
     * @throws IllegalArgumentException If the particle effect requires water and none is at the center location
     * @see ParticlePacket
     * @see ParticlePacket#sendTo(org.bukkit.Location, java.util.List)
     */
     ...
     * @see ParticlePacket#ParticlePacket(ParticleEffect, org.bukkit.util.Vector, float, boolean, ParticleData)
     * @see ParticlePacket#sendTo(org.bukkit.Location, double)
     */
     ...
     * @throws ParticleVersionException If the particle effect is not supported by the server version
     * @throws ParticleColorException   If the particle effect is not colorable or the color type is incorrect
     * @see #display(ParticleColor, org.bukkit.Location, java.util.List)
     */
     ...
     * @throws ParticleVersionException If the particle effect is not supported by the server version
     * @throws ParticleDataException    If the particle effect does not require additional data or if the data type is incorrect
     * @see #display(ParticleData, float, float, float, float, int, org.bukkit.Location, java.util.List)
     */
     ...
     * @throws ParticleVersionException If the particle effect is not supported by the server version
     * @throws ParticleDataException    If the particle effect does not require additional data or if the data type is incorrect
     * @see #display(ParticleData, org.bukkit.util.Vector, float, org.bukkit.Location, java.util.List)
     */
    ...
    public static final class ItemData extends ParticleData {
         ...
         * @see ParticleData#ParticleData(org.bukkit.Material, byte)
         */
    ...
    public static final class ParticlePacket {
         ...
         * @see #initializePacket(org.bukkit.Location)
         */
