...
public class SetupInventory {
    ...
    public SetupInventory(GameInstance gameInstance) {
        ...
        addItem(new ItemBuilder(new ItemStack(Material.NAME_TAG)).name(ChatColor.GOLD + "Set a mapname (currently: " + gameInstance.getMapName() == null ? "not set yet" : gameInstance.getMapName()).lore(ChatColor.GRAY + "Replace this nametag with another nametag").lore(ChatColor.GRAY + "that is named as the mapname").build(), gameInstance.getPlugin().getAbreviation() + " " + gameInstance.getID() + " set MAPNAME <NAME>");

        inventory.addItem((new ItemBuilder(new ItemStack(Material.APPLE)).name(ChatColor.GOLD + "Add villager spawns").lore(ChatColor.GRAY + "Click to add a villager spawn").lore(ChatColor.GRAY + "on the place you're standing").build()));
        inventory.addItem((new ItemBuilder(new ItemStack(Material.ROTTEN_FLESH)).name(ChatColor.GOLD + "Add zombie spawns").lore(ChatColor.GRAY + "Click to add a zombie spawn").lore(ChatColor.GRAY + "on the place you're standing").build()));
        inventory.addItem((new ItemBuilder(new ItemStack(Material.WOOD_DOOR)).name(ChatColor.GOLD + "Add doors").lore(ChatColor.GRAY + "Select a region with you WE").lore(ChatColor.GRAY + "wand and click").build()));
        inventory.addItem(new ItemBuilder(new ItemStack(Material.CHEST)).name(ChatColor.GOLD + "Set the chest shop").lore(ChatColor.GRAY + "Set the chest where in you ").lore(ChatColor.GRAY + "will put the shop items.").lore(ChatColor.GRAY + "Look at the chest").lore(ChatColor.GRAY + "and click this").build());
