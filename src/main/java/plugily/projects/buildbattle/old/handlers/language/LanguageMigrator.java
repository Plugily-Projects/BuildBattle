...
package plugily.projects.buildbattle.old.handlers.language;
...
public class LanguageMigrator {
  ...
  private void languageFileUpdate() {
    ...
    for(int i = version; i < LANGUAGE_FILE_VERSION; i++) {
      switch(version) {
        case 0:
          MigratorUtils.insertAfterLine(file, "BaseArena-Started", "  Wait-For-Start: \"&cYou must wait for arena start!\"");
          MigratorUtils.insertAfterLine(file, "No-BaseArena-Like-That", "  No-Playing: \"&cYou're not playing!\"");
        ...
        case 12:
          ...
          break;
        case 13:
          MigratorUtils.insertAfterLine(file, "Commands:", "  Type-BaseArena-Name: \"&cPlease type arena ID!\"");
          break;
        case 14:
        ...
        case 16:
          ...
          MigratorUtils.insertAfterLine(file, "Commands:", "  BaseArena-Restarting: \"&cThis arena is currently restarting!\"");
          break;
        case 17:
          MigratorUtils.addNewLines(file, "BaseArena-Selector:\r\n" +
              "  Inv-Title: \"BaseArena selector\"\r\n" +
              "  Item:\r\n" +
              "    Lore:\r\n" +
