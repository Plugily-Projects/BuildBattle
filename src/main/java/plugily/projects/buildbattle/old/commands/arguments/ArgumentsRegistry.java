...
package plugily.projects.buildbattle.old.commands.arguments;
...
import plugily.projects.buildbattle.old.commands.TabCompletion;
import plugily.projects.buildbattle.old.commands.arguments.admin.ListArenasArgument;
import plugily.projects.buildbattle.old.commands.arguments.admin.ReloadArgument;
import plugily.projects.buildbattle.old.commands.arguments.admin.TeleportArgument;
import plugily.projects.buildbattle.old.commands.arguments.admin.arena.AddNpcArgument;
import plugily.projects.buildbattle.old.commands.arguments.admin.arena.DeleteArgument;
import plugily.projects.buildbattle.old.commands.arguments.admin.arena.ForceStartArguments;
import plugily.projects.buildbattle.old.commands.arguments.admin.arena.SetThemeArgument;
import plugily.projects.buildbattle.old.commands.arguments.admin.arena.StopArgument;
import plugily.projects.buildbattle.old.commands.arguments.admin.plot.AddPlotArgument;
import plugily.projects.buildbattle.old.commands.arguments.admin.plot.PlotWandArgument;
import plugily.projects.buildbattle.old.commands.arguments.admin.plot.RemovePlotArgument;
import plugily.projects.buildbattle.old.commands.arguments.admin.plot.SelectPlotArgument;
import plugily.projects.buildbattle.old.commands.arguments.admin.votes.VotesArgument;
...
import plugily.projects.buildbattle.old.commands.arguments.game.ArenaSelectorArgument;
import plugily.projects.buildbattle.old.commands.arguments.game.CreateArgument;
import plugily.projects.buildbattle.old.commands.arguments.game.GuessArgument;
import plugily.projects.buildbattle.old.commands.arguments.game.JoinArguments;
import plugily.projects.buildbattle.old.commands.arguments.game.LeaderboardArgument;
import plugily.projects.buildbattle.old.commands.arguments.game.LeaveArgument;
import plugily.projects.buildbattle.old.commands.arguments.game.StatsArgument;
import plugily.projects.buildbattle.old.handlers.setup.SetupInventory;
        ...
        if(cmd.getName().equalsIgnoreCase("buildbattle")) {
          ...
          if(args.length > 1 && args[1].equalsIgnoreCase("edit")) {
            if(args[1].equalsIgnoreCase("edit") || args[0].equalsIgnoreCase("create")) {
              ...
              if(arena == null) {
                sender.sendMessage(plugin.getChatManager().getPrefix() + plugin.getChatManager().colorMessage("Commands.No-BaseArena-Like-That"));
                return true;
              }
